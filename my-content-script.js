...
(()=>{
    ...
    ;
    var Q = (e,t,n)=>(n = e != null ? Ae(He(e)) : {},
    je(t || !e || !e.__esModule ? q(n, "default", {
        value: e,
        enumerable: !0
    }) : n, e));
    var h = (e,t,n)=>(Ue(e, typeof t != "symbol" ? t + "" : t, n),
    n);
    var se = G((wt,U)=>{
        "use strict";
        var w = typeof Reflect == "object" ? Reflect : null, J = w && typeof w.apply == "function" ? w.apply : function(t, n, o) {
        ...
        c.prototype.emit = function(t) {
            ...
            if (typeof f == "function")
                ...
                for (var p = f.length, C = re(f, p), o = 0; o < p; ++o)
                    J(C[o], this, n);
            return !0
        }
        ;
        function ee(e, t, n, o) {
            ...
            s === void 0)
                s = a[t] = n,
                ++e._eventsCount;
            else if (typeof s == "function" ? s = a[t] = o ? [n, s] : [s, n] : o ? s.unshift(n) : s.push(n),
            r = Z(e),
        ...
        c.prototype.once = function(t, n) {
            return E(n),
            this.on(t, te(this, t, n)),
            this
        }
        ;
        c.prototype.prependOnceListener = function(t, n) {
            return E(n),
            this.prependListener(t, te(this, t, n)),
            this
        }
        ;
        c.prototype.removeListener = function(t, n) {
            ...
            if (o === n || o.listener === n)
                ...
                r.removeListener && this.emit("removeListener", t, o.listener || n));
                ...
                a === 0 ? o.shift() : $e(o, a),
                o.length === 1 && (r[t] = o[0]),
                r.removeListener !== void 0 && this.emit("removeListener", t, i || n)
            }
            return this
        }
        ;
        ...
        c.prototype.removeAllListeners = function(t) {
            ...
            if (o.removeListener === void 0)
                ...
                this._eventsCount = 0) : o[t] !== void 0 && (--this._eventsCount === 0 ? this._events = Object.create(null) : delete o[t]),
                this;
        ...
        function ae(e, t, n, o) {
            if (typeof e.on == "function")
                ...
                e.addEventListener(t, function r(a) {
                    o.once && e.removeEventListener(t, r),
                    n(a)
                });
            else
    ...
    var Qe = (()=>{
      ...
      , ie = 4096;
    function ce() {
        (j === void 0 || R + 16 > ie) && (R = 0,
        j = Qe(ie));
        let e = Array.prototype.slice.call(j, R, R += 16);
    ...
    var Je = {
        ...
        number: ()=>8,
        string: e=>2 * e.length,
        object: e=>e ? Object.keys(e).reduce((t,n)=>N(n) + N(e[n]) + t, 0) : 0
    }
      , N = e=>Je[typeof e](e)
    ...
    ;
    var De = Q(de());
    var Xe = chrome.runtime.getURL("assets/config.js"), fe, P = (fe = globalThis.browser) != null ? fe : globalThis.chrome;
    async function Ye() {
        ...
        p.replace(v, "").split(",").forEach(_e=>{
            ...
            if (k && z) {
                ...
                for (let y = 0; y < n.length; y++)
                    k.endsWith(n[y]) && (S = Number(S));
                for (let y = 0; y < o.length; y++)
                    k.startsWith(o[y]) && (S = S === "true");
                t[k] = S
            }
        }
        ),
        ...
        return t.blackUrlList = Be.split(","),
        P.storage.local.set({
            defaultConfig: t
        }),
        t
    ...
    async function ge() {
        ...
        for (let n of t)
            if (!(n === "proxyType" && !ue[n].includes(e[n]))) {
                {
                    if (n.endsWith("Mode") && !ue.mode.includes(e[n]))
                        continue;
                    if (n === "port") {
    ...
    function he(e) {
        ...
        e.on("registerCaptchaWidget", ({data: t, respond: n})=>{
    ...
    function me() {
        ...
        e || (e = document.createElement("capsolver-widgets"),
        document.head.appendChild(e)),
        window.registerCaptchaWidget = t=>{
            let n = et(t);
            if (window.isCaptchaWidgetRegistered(n))
                return;
        ...
        window.isCaptchaWidgetRegistered = t=>{
            let {captchaType: n, widgetId: o} = t
              , r = e.children;
        ...
        window.getCaptchaWidget = t=>{
            let {captchaType: n} = t
              , o = `capsolver-widget[data-captcha-type="${n}"]`;
    ...
    function et(e) {
        let t = {};
        for (let n in e)
            e[n] === null || e[n] === void 0 || (t[n] = `${e[n]}`);
        return t
    }
    function K() {
        let e = document.createElement("div");
        e.id = "capsolver-solver-tip-button",
        e.classList.add("capsolver-solver"),
        e.dataset.state = "solving";
        let t = document.createElement("div");
        t.classList.add("capsolver-solver-image");
        let n = document.createElement("img");
        n.src = chrome.runtime.getURL("assets/images/logo_solved.png"),
        n.alt = "",
        t.appendChild(n);
        let o = document.createElement("div");
        return o.classList.add("capsolver-solver-info"),
        o.innerText = chrome.i18n.getMessage("solving"),
        e.appendChild(t),
        e.appendChild(o),
        e
    }
    ...
    var B = class {
        ...
        setSolveButton(t, n) {
            let o = document.querySelector(`#${t.containerId}`)
              , r = n;
            r.style.width = o.querySelector("iframe").offsetWidth + "px",
            o.append(r)
        }
        getParams(t, n) {
            return {
    ...
    var W = class {
        ...
        setSolveButton(t, n) {
            ...
            r.textarea && r.textarea.parentElement ? (r.textarea.parentElement.style.height = "auto",
            r.textarea.parentElement.insertBefore(o, r.textarea.nextSibling)) : r.button.parentElement.insertBefore(o, r.button.nextSibling)
        }
        getParams(t, n) {
            return {
                sitekey: t.sitekey,
        ...
        onSolved(t, n) {
            ...
            o || (o = (r = this.getForm(t)) == null ? void 0 : r.querySelector("textarea[name=g-recaptcha-response]")),
            o.innerHTML = n,
            o.value = n
        }
        getForm(t) {
    ...
    var _ = class {
        ...
        setSolveButton(t, n) {
            ...
            r.style.left = rt(o.querySelector("iframe").offsetWidth) + "px",
            r.style.bottom = "20px",
            o.append(r)
        }
        getParams(t) {
    ...
    var F = class {
        ...
        setSolveButton(t, n) {
            let o = document.querySelector(`#${t.containerId}`)
              , r = n;
            r.style.width = (o == null ? void 0 : o.offsetWidth) + "px",
            o == null || o.append(r)
        }
    }
    ;
    ...
    function ve(e) {
        m.register(new B),
        m.register(new W("reCaptcha")),
        m.register(new W("reCaptcha3")),
        m.register(new _),
        m.register(new A),
        m.register(new F)
    }
    ...
    function ct(e) {
        var t;
        try {
            if ((t = e.request) != null && t.messageId)
                return pt(e);
            let n = {
            ...
            e.error ? (g.getAll().then(o=>{
                e.error === "Error: Capsover: No API Kye set up yet!" && !(o != null && o.apiKey) && u("Please input your API key!", "error"),
                o[`${n.captchaType}RepeatTimes`] >= ye ? window.setCaptchaWidgetDataset(n.widgetId, "status", "ready") : (window.setCaptchaWidgetDataset(n.widgetId, "status", "error"),
                u(e.error, "error"))
            }
            ),
            ye++) : (window.setCaptchaWidgetDataset(n.widgetId, "status", "success"),
            lt(e),
            Te())
        } catch (n) {
    ...
    function lt(e) {
        ...
        if (o) {
            ...
            r.id = "capsolver-callback-trigger",
            r.setAttribute("data-function", o),
            r.value = e.response.code,
    ...
    function Se(e) {
        if (document.querySelector("#capsolver-solver-tip-button"))
            return;
    ...
    function dt(e, t) {
        ...
        ,
        n.setSolveButton(e, o),
        u(chrome.i18n.getMessage("solveWithCapsolver"), "ready")
    }
    function Le() {
        window.getSolverButton = e=>{
            let {captchaType: t, widgetId: n} = e
              , o = `.capsolver-solver[data-captcha-type="${t}"][data-widget-id="${n}"]`;
            return document.querySelector(o)
        }
        ,
        ...
        window.onTaskByToken = e=>{
            let {captchaType: t, widgetId: n} = e
              , o = window.getCaptchaWidgetDataset(t, n);
            g.getAll().then(r=>{
                ...
                window.setCaptchaWidgetDataset(n, "status", "processing"),
                chrome.runtime.sendMessage(i).then(xe)
            }
            )
        }
    }
    var ut = (e,t)=>{
        let n = new Map([["funCaptcha", "enabledForFunCaptcha"], ["hCaptcha", "enabledForHCaptcha"], ["reCaptcha", "enabledForRecaptcha"], ["reCaptcha3", "enabledForRecaptchaV3"], ["cloudflare", "enabledForCloudflare"], ["awsCaptcha", "enabledForAwsCaptcha"]]);
    ...
    function Me() {
        return setInterval(async()=>{
            ...
            for (let n = 0; n < t.length; n++) {
                ...
                if (!(e != null && e.apiKey)) {
                    Se(r),
                    u("Please input your API key!", "error");
                    return
                }
    ...
    ke.src = chrome.runtime.getURL("assets/inject/solvedCallback.js");
    ...
    var We, mt = (We = globalThis.browser) != null ? We : globalThis.chrome;
    mt.storage.local.set({
        platform: window.navigator.userAgent.includes("Chrome") ? "chrome" : "firefox"
    });
    chrome.runtime.onMessage.addListener((e,t,n)=>{
        var a, s;
        let o = (a = e == null ? void 0 : e.response) == null ? void 0 : a.action
          , r = (s = e == null ? void 0 : e.response) == null ? void 0 : s.callback;
        switch (o) {
        case "solved":
            u(chrome.i18n.getMessage("solved"), "solved"),
            window.postMessage({
    ...
    g.getAll().then(function(e) {
        ...
        g.set({
            ...
            (!e.enabledForBlacklistControl || !a) && e.useCapsolver && (Ie.push(Me()),
            Ct(),
            vt())
        }
        )
    ...
    document instanceof HTMLDocument && yt(chrome.runtime.getURL("dom.js"));
    pe(Pe, "bex-dom");
    Ee(Pe);
}
)();
